...
$extensionmobility = new PluginLinesmanagerExtensionmobility();
...
if (PluginLinesmanagerLine::checkPostArgumentsPermissions()) {
    ...
    if (isset($_POST['update']) or isset($_POST['add'])) {
        $error = $extensionmobility->checkArguments($_POST);
    ...
    try {
        ...
        if (isset($_POST['purge'])) {
            $result = $extensionmobility->delete($_POST);
            Html::redirect(PluginLinesmanagerExtensionmobility::getFormURL());
        }
